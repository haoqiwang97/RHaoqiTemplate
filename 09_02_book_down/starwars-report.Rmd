...
All charts in this report are generated from the `starwars` dataset in the `dplyr` package. Let's take a look at the dataset in the table below \@ref(tab:starwars-report-1).
